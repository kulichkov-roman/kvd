...
$APPLICATION->IncludeComponent("your:iblock.element.add.form", "feedback_top", Array(
	"CUSTOM_TITLE_DATE_ACTIVE_FROM" => "",	// * дата начала *
		...
		"MAX_LEVELS" => "100",	// Ограничить кол-во рубрик, в которые можно добавлять элемент
		"MAX_USER_ENTRIES" => "100",	// Ограничить кол-во элементов для одного пользователя
		"PREFIX_FORM" => "top",	// Префикс к форме
