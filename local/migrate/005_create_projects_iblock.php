...
class CreateHeroSliderIBlockMigration extends AbstractIBlockMigration
{
    ...
    public function up()
    {
        ...
        try {
            ...
            $logger->log(
                sprintf('IBlock has been created. Id: "%s". Add to "projectsIBlockId"', $this->iblockId)
            );
    ...
    public function down()
    {
        ...
        $this->deleteIBlock($environment->get('projectsIBlockId'));

        $logger->log(sprintf('IBlock projects has been removed. Id: "%s"', $this->iblockId));
    }
}
